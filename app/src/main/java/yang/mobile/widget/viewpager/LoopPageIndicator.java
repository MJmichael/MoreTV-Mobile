 ...
 */
public class LoopPageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float threeRadius = mRadius * 3 + 2 * stokenWidth;
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            ...
            if (mPaintPageFill.getAlpha() > 0) {
                canvas.drawCircle(dX, dY, pageFillRadius + stokenWidth, mPaintPageFill);
            }
        }
    ...
    private int measureLong(int measureSpec) {
        ...
        if ((specMode == MeasureSpec.EXACTLY) || (mViewPager == null)) {
            ...
            result = (int)(getPaddingLeft() + getPaddingRight()
                    + (count * (3 * mRadius + 2 * stokenWidth)) - mRadius + 1);
