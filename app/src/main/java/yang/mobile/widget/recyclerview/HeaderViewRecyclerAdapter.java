...
public class HeaderViewRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<View> mInvisibleFooterViews;
    private List<View> mInvisibleHeaderViews;
    ...
    public HeaderViewRecyclerAdapter(RecyclerView.Adapter adapter) {
        ...
        mInvisibleFooterViews = new ArrayList<>();
        mInvisibleHeaderViews = new ArrayList<>();
    ...
    public void addHeaderView(View view) {
        ...
        if (mHeaderViews.contains(view)) {
            ...
            mInvisibleHeaderViews.remove(view);
        } else {
    ...
    public void removeHeaderView(View view) {
        if (mHeaderViews.contains(view)) {
            ...
            params.height = 0;
            view.setLayoutParams(params);
            if (!mInvisibleHeaderViews.contains(view)) {
                mInvisibleHeaderViews.add(view);
            }
    ...
    public void addFooterView(View view) {
        ...
        if (mFooterViews.contains(view)) {
            ...
            view.setLayoutParams(params);
            mInvisibleFooterViews.remove(view);
        } else {
    ...
    public void removeFooterView(View view) {
        if (mFooterViews.contains(view)) {
            ...
            params.height = 0;
            view.setLayoutParams(params);
            if (!mInvisibleFooterViews.contains(view)) {
                mInvisibleFooterViews.add(view);
            }
    ...
    public int getInvisibleFooterViewCount() {
        return mInvisibleFooterViews.size();
    }

    public int getInvisibleHeaderViewCount() {
        return mInvisibleHeaderViews.size();
    }

    public int getInvisibleViewCount() {
        return getInvisibleFooterViewCount() + getInvisibleHeaderViewCount();
